...
from Exercise7Task1 import median
...
class MedianTests(TestCase):
    ...
    def test_median_works_for_empy_list(self):
        self.assertEqual(None, median([]))

    def test_median_even_lists_with_float(self):
        self.assertAlmostEqual(2.5, median([1, 2, 3, 4]))